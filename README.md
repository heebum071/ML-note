...
(1) Get better algorithm with computer science perspective (2) Find statistical guarantee on algorithms 
(1) is more important for practitioner. Academics overweigh (2). (So, only (1) can be easily monetized.) 
